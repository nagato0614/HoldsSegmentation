...
class trainer(object):
    ...
    def train(self, train_img, train_lab, test_images, test_labels, out_path,
              batch_size, epochs):
        print("\n\n___Start training...")

        his = self.resnet.fit(train_img, train_lab, batch_size=batch_size,
                              epochs=epochs)
...
def main():
    ...
    test_images, test_labels) = f_mnist.load_data()
    ...
    # Trainer = trainer()
    # Trainer.train(train_imgs, train_labels, test_imgs, test_labels, args.out,
